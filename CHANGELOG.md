...
- Enable `helm-docs` for auto-generated chart README and `helm-values-schema-json` for values schema generation.
...
[Unreleased]: https://github.com/giantswarm/external-secrets/compare/v0.20.5...HEAD
